...
import (
	...
	"patreon/internal/app/delivery/http/handlers/creator_id_handler/aw_id_handler/upd_aw_handler"
	...
	"patreon/internal/app/delivery/http/handlers/creator_id_handler/posts_id_handler/upd_handler"
	upl_cover_posts_handler "patreon/internal/app/delivery/http/handlers/creator_id_handler/posts_id_handler/upl_cover_handler"
...
func (f *HandlerFactory) initAllHandlers() map[int]app.Handler {
	...
	return map[int]app.Handler{
		...
		POST_UPL_COVER:         upl_cover_posts_handler.NewPostsUploadCoverHandler(f.logger, f.router, f.cors, ucPosts, sManager),
...
func (f *HandlerFactory) GetHandleUrls() *map[string]app.Handler {
	...
	f.urlHandler = &map[string]app.Handler{
		...
		"/creators/{creator_id:[0-9]+}/posts/{post_id:[0-9]+}/cover":  hs[POST_UPL_COVER],
